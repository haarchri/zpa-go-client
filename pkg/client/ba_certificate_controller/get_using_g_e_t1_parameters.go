...
/* GetUsingGET1Params contains all the parameters to send to the API endpoint
   for the get using g e t 1 operation.
...
// WithDefaults hydrates default values in the get using g e t 1 params (not the query body).
//
...
// SetDefaults hydrates default values in the get using g e t 1 params (not the query body).
//
// All values with no default are reset to their zero value.
